...
export function WhatsAppButton() {
  ...
  if (minimized) {
    return (
      <motion.button
        ...
        className="fixed bottom-6 left-4 z-[9998] w-9 h-9 rounded-full flex items-center justify-center shadow-md"
  ...
  return (
    <div className="fixed bottom-6 left-4 z-[9998] flex flex-col items-start gap-2">
      <AnimatePresence>
        {expanded && (
          <motion.div
      ...
      <div className="flex items-center gap-1.5">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="w-7 h-7 rounded-full flex items-center justify-center bg-white shadow-md border border-gray-200"
